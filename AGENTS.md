...
app/
  ...
  models/          # SQLModel ORM models (User, Session, Thread, Document)
  schemas/         # Pydantic request/response schemas + graph state
  services/        # Business logic (llm/, database.py, document_service.py, memory.py, session_naming.py)
  utils/           # Shared utilities
static/            # Single-page test UI (served at /ui)
